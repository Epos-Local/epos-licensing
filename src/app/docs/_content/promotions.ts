...
/**
 * Sourced from PromotionMatcher/OrderItemService: promotions apply the
 * moment a matching product is added, with no staff action and no on-screen
 * label, a product-specific promotion always wins over a category-wide one
 * on the same line rather than stacking, and a FixedPrice promotion silently
 * overrides the unit price with nothing to mark it as a promotion at all.
 */
  ...
  sections: [
    ...
    },
    {
      ...
      blocks: [
        {
          kind: "p",
          text: "A promotion can run all the time, or be limited by a start and end date, a start and end time of day, and which days of the week it is active on. Leave the start and end time both at midnight to mean all day, not no time at all.",
        },
      ],
    },
    {
